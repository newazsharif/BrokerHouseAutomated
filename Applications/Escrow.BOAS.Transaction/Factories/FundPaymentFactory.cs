...
{
    public class FundPaymentFactory : GenericFactory<TransactionEntities, tblFundWithdraw>, IFundPaymentFactory
    {
        ...
        public dynamic getFundPaymentApproveList()
        {
            var obj = this.Context.ssp_payment_approve_list().ToList();
