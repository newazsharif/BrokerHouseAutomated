...
namespace Escrow.BOAS.Trade.Models
{
    ...
    public partial class DimDate
    {
        public DimDate()
        {
            ...
            this.tblNonTradingMasters1 = new HashSet<tblNonTradingMaster>();
            this.tblNonTradingDetails = new HashSet<tblNonTradingDetail>();
            this.tblFTOmnibusImportLogs = new HashSet<tblFTOmnibusImportLog>();
        ...
        public virtual ICollection<tblNonTradingMaster> tblNonTradingMasters1 { get; set; }
        public virtual ICollection<tblNonTradingDetail> tblNonTradingDetails { get; set; }
        public virtual ICollection<tblFTOmnibusImportLog> tblFTOmnibusImportLogs { get; set; }
