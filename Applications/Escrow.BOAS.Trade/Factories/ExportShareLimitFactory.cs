...
{
    public class ExportShareLimitFactory : IExportShareLimitFactory
    {
        ...
        public DataSet getShareLimits(decimal export_dt, bool isMorning, string omb_ids, string fileName, string branch_ids, decimal membership_id, string connStr)
        {
            string sqlQuery = string.Empty;
            if (isMorning == true)
            {
                sqlQuery = "[Trade].[psp_ft_exp_positions_morning]";
            }
            else
            {
                sqlQuery = "[Trade].[psp_ft_exp_positions_intraday]";
        ...
        public string ConvertToShareLimitXMLString(DataSet ds, bool isMorning)
        {
            return oXmlManager.ConvertToPositionXMLString(ds, isMorning);
        }
