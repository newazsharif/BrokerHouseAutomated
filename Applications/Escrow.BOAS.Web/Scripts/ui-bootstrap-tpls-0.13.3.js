...
.controller('DatepickerController', ['$scope', '$attrs', '$parse', '$interpolate', '$log', 'dateFilter', 'datepickerConfig', '$datepickerSuppressError', function($scope, $attrs, $parse, $interpolate, $log, dateFilter, datepickerConfig, $datepickerSuppressError) {
  ...
  this.isDisabled = function (date) {
      ...
      /*---------------- added by shohid for converting date formate from mm/dd/yyyy to dd/mm/yyyy  09 Feb 2016 ------------------------*/
     
      if(this.minDate != null && this.maxDate != null)   // if min date and max date correctly set in view
      {
          var minYear = this.minDate.getFullYear();
          var minMonth = parseInt(this.minDate.getMonth());
          ...
          // end of conversion
          return ((minDate && this.compare(date, minDate) < 0) || (maxDate && this.compare(date, maxDate) > 0) || ($attrs.dateDisabled && $scope.dateDisabled({ date: date, mode: $scope.datepickerMode })));
      }
      else if (this.minDate == null && this.maxDate != null)
      {
          minDate = new Date(1970, 0, 01);
          var maxYear = this.maxDate.getFullYear();
          var maxMonth = parseInt(this.maxDate.getMonth());
          var maxDay = this.maxDate.getDate();
          var maxDate = new Date(maxYear, maxMonth, maxDay);
      ...
      else // if min date and max date is not set or invalide 
      {
          minDate = new Date(1970, 0, 01);
          maxDate = new Date(2099, 0, 01);
          return ((minDate && this.compare(date, minDate) < 0) || (maxDate && this.compare(date, maxDate) > 0) || ($attrs.dateDisabled && $scope.dateDisabled({ date: date, mode: $scope.datepickerMode })));
