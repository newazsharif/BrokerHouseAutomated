            ...
            ctrl.$parsers.unshift(function (viewValue) {
                ...
                var inputVal = viewValue;
                    if ((maxValue && minValue) != undefined) {
                        if (attrs.required == undefined && inputVal == "") {
                            ctrl.$setValidity('num', true);
                            return true;
                        }
                        else if (parseInt(maxValue) >= parseInt(inputVal) && parseInt(minValue) <= parseInt(inputVal)) {
                        ctrl.$setValidity('num', true);
                        return viewValue;
                    }
                    else {
                    ...
                    if ((maxLangth && minLangth) != undefined) {
                        ...
                        else if (parseInt(maxLangth) >= parseInt(inputLen) && parseInt(minLangth) <= parseInt(inputLen)) {
                        ctrl.$setValidity('text', true);
                        return viewValue;
                    }
                    else {
