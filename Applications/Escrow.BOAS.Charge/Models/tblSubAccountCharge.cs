...
namespace Escrow.BOAS.Charge.Models
{
    ...
    public partial class tblSubAccountCharge
    {
        public tblSubAccountCharge()
        {
            this.tblSubAccountChargeSlabs = new HashSet<tblSubAccountChargeSlab>();
        }
    
        public decimal id { get; set; }
        public decimal sub_account_id { get; set; }
        ...
        public virtual ICollection<tblSubAccountChargeSlab> tblSubAccountChargeSlabs { get; set; }
