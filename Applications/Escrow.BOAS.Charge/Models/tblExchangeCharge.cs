...
namespace Escrow.BOAS.Charge.Models
{
    ...
    public partial class tblExchangeCharge
    {
        public tblExchangeCharge()
        {
            this.tblExchangeChargeSlabs = new HashSet<tblExchangeChargeSlab>();
        }
        ...
        public virtual ICollection<tblExchangeChargeSlab> tblExchangeChargeSlabs { get; set; }
    }
}
