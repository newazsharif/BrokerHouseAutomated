...
CREATE TABLE	[dbo].[DimDate]
	(	[DateKey] NUMERIC(9,0) primary key, 
		[Date] DATETIME,
		...
		[IsHoliday] BIT,-- Flag 1=Holiday, 0-No Holiday
		[Holiday] VARCHAR(50) Null --Name of Holiday in this system
	)
GO
...
ALTER TABLE [Escrow.BOAS].[dbo].[DimDate] ADD [FullDateCDBL] VARCHAR(11) NULL;




update dm
set dm.FullDateCDBL = right(replicate('0',2) + dm.DayOfMonth,2) + '-' + upper(dm.MonthYear)
from [Escrow.BOAS].[dbo].[DimDate] dm